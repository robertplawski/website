...
export function ProjectContainer() {
  ...
  const showcasedProject = {
    ...
    description: {
      "pl-PL":
        "**To ta strona, którą właśnie oglądasz.** To jest statyczna strona zrobiona w React. Strona jest hostowana na domowym serwerze w kontenerze LXC oraz korzysta z Cloudflare DNS.",
      "en-US":
        "**This is the page you are currently viewing.** This is a static page made in React. The page is hosted on a home server in an LXC container and uses Cloudflare DNS.",
    },
    showFull: true,
    tags: [
  ...
  const projects = [
    {
      ...
      cta: {
        "pl-PL": "Kliknij tutaj aby zagrać!",
        "en-US": "Click here to play!",
      },
      thumbnailVideoSrc: cardGameVideo,
      thumbnailVideoPlaybackRate: 1.2,
      description: {
        "pl-PL":
          "Zagraj z swoimi przyjaciółmi, gra bazowana na popularnej grze UNO. ",
        "en-US":
          "Play a card game with your friends, game based on popular UNO card game",
      },
    ...
    },
    {
      ...
      description: {
        ...
        "en-US":
          "A simple ping pong game. Play against the computer or friends!",
      },
    ...
    {
      id: "tic-tac-toe",
      title: { "pl-PL": "Kółko i krzyżyk", "en-US": "Tic-tac-toe" },
      cta: {
        "pl-PL": "Kliknij tutaj aby zagrać!",
        "en-US": "Click here to play!",
      },
      ...
      description: {
        "pl-PL":
          "Klasyk gier podwórkowych! Graj z algorytmem na różnym poziomie. ",
        "en-US":
          "A childhood classic! Play with an algorithm at different levels.",
      },
      repositoryUrl: "https://github.com/robertplawski/tic-tac-toe-react",
      demoUrl: "https://robertplawski.github.io/tic-tac-toe-react",
    ...
    {
      title: {
        "pl-PL": "Koło fortuny [WIP]",
        "en-US": "Wheel of fortune [WIP]",
      },
      ...
      description: {
        "pl-PL":
          "Zagraj z swoimi przyjaciółmi, gra bazowana na sławnym teleturnieju.",
...

    {
      ...
      description: {
        "pl-PL":
          "Ta aplikacja zwiększy twoją produktywność. Aplikacja pozwala na tworzenie notatek, czy list.  ",
        "en-US":
          "This application will increase your productivity. Application allows to create notes or lists.",
      },
      /*repositoryUrl: "https://github.com/robertplawski/kolo-fortuny",
      demoUrl: "https://play-no-card-game.robertplawski.pl/",*/
      hidden: true,
  ...
  const SORTERS = {
    ...
    "alphabetically-ascending": (a, b) =>
      localeCompare(
        a.title[language] || a.title[DEFAULT_LANGUAGE],
        b.title[language] || b.title[DEFAULT_LANGUAGE]
      ),
    "alphabetically-descending": (a, b) =>
      localeCompare(
        b.title[language] || b.title[DEFAULT_LANGUAGE],
        a.title[language] || a.title[DEFAULT_LANGUAGE]
      ),
    ...
    <Fade delay={300}>
      ...
      <div className="projects-container">
        ...
        {projects
          ...
          .sort(SORTERS[sort])
          .map((project, index) => (
            <Project key={index} {...{ ...project, index }} />
          ))}
      </div>
