...
const checkIfLanguageSupported = (check) => {
  return (
    SUPPORTED_LANGUAGES.find((language) => language === check) ||
    DEFAULT_LANGUAGE
  );
};
...
const LOOKUP_TABLE = {
  "en-US": {
    ...
    blog: "Blog",
    "blog-description":
      "I present to you my blog site about technology, sports, self-growth and other topics that interest me. Returning to the original idea of a blog, it's my personal online diary. Ahead of you lies a true mish-mash of content! ",
    ...
    "portfolio-description": "See my projects in practice!",
    copyright: "Copyright",
    share: "Share",
...
* virtual machines: qemu/kvm, proxmox`,
  ...
  "pl-PL": {
    ...
    blog: "Blog",
    "blog-description":
      "Zobacz mojego mini-bloga na tematy technologiczne, sportowe, samorozwojowe oraz jakiekolwiek mi przyjdą na myśl. Wraz z pierwotną ideą bloga to mój osobisty e-dzienniczek.\nPrzed tobą prawdziwy miszmasz zawartości! ",
    ...
    "portfolio-description": "Zobacz moje projekty w praktyce!",
    share: "Udostępnij",
...
export const InternationalizationContextProvider = ({ children }) => {
  ...
  const lookup = (word, lang = language) =>
    LOOKUP_TABLE[lang][word]
      ? LOOKUP_TABLE[lang][word]
      : LOOKUP_TABLE[DEFAULT_LANGUAGE][word];
